...
module.exports = class jsonsplitter {
    ...
    getKey = (keypath) => {
        ...
        let filenum = this.addKeysToObject(objpath.object_main.keys, objpath.keys.slice(1))?.[objpath.keys[objpath.keys.length - 1]];
        ...
        return this.getKeysFromObject(file, objpath.keys);
    };
