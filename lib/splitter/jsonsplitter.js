...
class jsonsplitter {
    ...
    create = (object) => {
        ...
        objdir.forEach(obj => {
            ...
            objmain.num = 0;
            objmain.keys = {};
            if (keychunks.length === 0) _wf(this.symbol, _mainpath(this.symbol, [...obj.path, `${i}.json`]), this.createObjectFromKeys(obj.path, {}));
        ...
        return new Promise(async (resolve, reject) => {
            ...
            this.getMainKey(mainkeypath)
                .then(filenum => {
                    ...
                    this.deleteKeyFromObject(objpath.object_main, ["keys", objpath.keys[1]])
                        .then(newmainfile => {
