...
function _log(logopt, logmsg, logcolorfg, logcolorbg){
    ...
    if(logopt === 0){
        ...
        console.error(`${_returner(3, logcolorbg, undefined, "\x1b[41m")}${_returner(3, logcolorfg, undefined, "")} ${date_()}\x1b[0m${_returner(3, logcolorbg, undefined, "\x1b[41m")}${_returner(3, logcolorfg, undefined, "")} \x1b[0m > ${logmsg.message}\n`, logmsg);
        // red
    }
};
